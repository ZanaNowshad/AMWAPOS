...
export const AR: Record<string, string> = {
  ...
  "A read-only page for the owner's phone on the store network: today's sales, pending deliveries and low stock.":
    "صفحة للقراءة فقط لهاتف المالك على شبكة المتجر: مبيعات اليوم والتوصيلات المعلقة والمخزون المنخفض.",
  "A read-only page for the owner's phone on the store network: today's sales, pending deliveries and low stock. Needs the hub and a short-lived link issued from Admin → Phone view.":
    "صفحة للقراءة فقط لهاتف المالك على شبكة المتجر: مبيعات اليوم والتوصيلات المعلقة والمخزون المنخفض. تحتاج إلى الخادم ورابط قصير الأجل يُصدر من الإدارة ← عرض الهاتف.",
  ...
  "Add a product: type a name, SKU or barcode…": "أضف منتجاً: اكتب الاسم أو رمز الصنف أو الباركود…",
  ...
  "Amount paid for one point": "المبلغ المدفوع مقابل نقطة واحدة",
  ...
  "At or below the reorder point": "عند حد إعادة الطلب أو أقل",
  ...
  "Branch price": "سعر الفرع",
  "Branch prices": "أسعار الفروع",
  Branches: "الفروع",
  "Branches for {0}": "فروع {0}",
  ...
  "Create order from this message": "إنشاء طلب من هذه الرسالة",
  ...
  "Customers earn one point for each of this amount paid, after discounts. Points are whole numbers.":
    "يكسب العملاء نقطة واحدة عن كل مبلغ من هذا القدر مدفوع بعد الخصومات. النقاط أعداد صحيحة.",
  ...
  "Delete {0}": "حذف {0}",
  "Deliver this order": "توصيل هذا الطلب",
  ...
  "Digital orders": "الطلبات الرقمية",
  "Digital orders (phone, WhatsApp, web)": "الطلبات الرقمية (هاتف، واتساب، ويب)",
  Direct: "مباشر",
  ...
  Document: "المستند",
  Done: "تم",
  "Download CSV pack (zip)": "تنزيل حزمة CSV (zip)",
  "Download {0}": "تنزيل {0}",
  "Downloaded and verified": "تم التنزيل والتحقق",
  Draft: "مسودة",
  "Draft order created": "تم إنشاء مسودة الأمر",
  "Draft order saved. Confirm it in Digital orders.": "حُفظت مسودة الطلب. أكّدها في الطلبات الرقمية.",
  ...
  Earned: "مكتسبة",
  "Earned points reversed": "عكس النقاط المكتسبة",
  Edit: "تعديل",
  ...
  "Expected in drawer = opening float + cash sales − cash refunds + paid in − paid out − safe drops. Card, wallet and account payments are not in the drawer.":
    "المتوقع في الدرج = الرصيد الافتتاحي + المبيعات النقدية − المرتجعات النقدية + الإيداعات − المسحوبات − الإيداعات في الخزنة. مدفوعات البطاقة والمحفظة والحساب ليست في الدرج.",
  ...
  "Hold or finish the current sale before selling an order.": "علّق البيع الحالي أو أنهِه قبل بيع طلب.",
  ...
  "Last supplier cost": "آخر تكلفة من المورد",
  ...
  "Leave empty to use the shared price. A branch price applies only to tills in that branch.":
    "اتركه فارغاً لاستخدام السعر المشترك. سعر الفرع يُطبَّق فقط على نقاط البيع في ذلك الفرع.",
  ...
  Locations: "المواقع",
  "Locations & transfers": "المواقع والتحويلات",
  Lock: "قفل",
  ...
  "Move stock between locations and branches: draft, ship, receive. A transfer never creates stock.":
    "انقل المخزون بين المواقع والفروع: مسودة، شحن، استلام. التحويل لا يُنشئ مخزوناً أبداً.",
  ...
  "Name this range": "سمِّ هذه الفترة",
  ...
  "New terminal joins branch": "نقطة البيع الجديدة تنضم إلى الفرع",
  ...
  "No devices yet. Pair a till into this branch from Sync / Hub.":
    "لا توجد أجهزة بعد. اربط نقطة بيع بهذا الفرع من المزامنة / الخادم.",
  "No expected amount: link a delivery or enter the amount": "لا يوجد مبلغ متوقع: اربط طلب توصيل أو أدخل المبلغ",
  "No expected date": "بدون تاريخ متوقع",
  "No field changes recorded.": "لم تُسجّل تغييرات على الحقول.",
  "No held sale with ticket {0}.": "لا يوجد بيع معلق بالتذكرة {0}.",
  ...
  "Not available to your role.": "غير متاح لدورك.",
  ...
  "Nothing recorded here": "لا شيء مسجل هنا",
  "Nothing recorded.": "لا شيء مسجل.",
  ...
  "On time: first delivery on or before the expected date. Late includes orders past their date with nothing received.":
    "في الموعد: أول تسليم في التاريخ المتوقع أو قبله. المتأخر يشمل الطلبات التي تجاوزت تاريخها دون استلام أي شيء.",
  ...
  "One hub serves every branch on this network. Each till belongs to one branch, chosen when it is paired.":
    "خادم واحد يخدم كل الفروع على هذه الشبكة. تنتمي كل نقطة بيع إلى فرع واحد يُختار عند الربط.",
  ...
  "Order loaded. Take payment as usual.": "حُمّل الطلب. استلم الدفع كالمعتاد.",
  "Order number from the website or app, if any.": "رقم الطلب من الموقع أو التطبيق، إن وجد.",
  "Order total above {0}": "إجمالي الأمر أعلى من {0}",
  "Order {0}": "الطلب {0}",
  Ordered: "مطلوب",
  "Ordered Qty": "الكمية المطلوبة",
  "Ordered vs received quantity and on-time deliveries per supplier":
    "الكمية المطلوبة مقابل المستلمة والتسليم في الموعد لكل مورد",
  Orders: "الطلبات",
  "Orders taken by phone, WhatsApp or the website appear here until they are sold.":
    "تظهر هنا الطلبات الواردة بالهاتف أو واتساب أو الموقع حتى تُباع.",
  ...
  "Owner phone view": "عرض الهاتف للمالك",
  "PAY {0}": "ادفع {0}",
  PDF: "PDF",
  ...
  "Points to redeem": "النقاط المراد استبدالها",
  ...
  "Quantities must be more than zero.": "يجب أن تكون الكميات أكبر من صفر.",
  Quantity: "الكمية",
  ...
  Redeemed: "مستبدلة",
  "Redeemed points become a discount on the sale, never cash.":
    "النقاط المستبدلة تصبح خصماً على البيع، وليست نقداً أبداً.",
  "Redeemed points returned": "إرجاع النقاط المستبدلة",
  ...
  "Remove redemption": "إزالة الاستبدال",
  ...
  "Sale held as ticket #{0}": "عُلّق البيع كتذكرة رقم {0}",
  "Sale line": "سطر البيع",
  ...
  "Save limit": "حفظ الحد",
  "Save role": "حفظ الدور",
  "Save this range": "حفظ هذه الفترة",
  Saved: "تم الحفظ",
  ...
  "Screenshot pending": "بانتظار لقطة الشاشة",
  ...
  "Sell on this till": "البيع على نقطة البيع هذه",
  ...
  "Separate from the figures above. The assistant may be wrong; the recorded figures are the reference.":
    "منفصل عن الأرقام أعلاه. قد يخطئ المساعد؛ الأرقام المسجلة هي المرجع.",
  Session: "الجلسة",
  ...
  "Short code, e.g. SHELF or COLD": "رمز قصير، مثل SHELF أو COLD",
  ...
  "Some sections are hidden because your role cannot see them.": "بعض الأقسام مخفية لأن دورك لا يسمح برؤيتها.",
  ...
  "Splits a branch's stock into locations (stockroom, shelf, …) and moves it with transfers: draft, ship, receive. A transfer never creates stock.":
    "يقسّم مخزون الفرع إلى مواقع (مستودع، رف، …) وينقله بالتحويلات: مسودة، شحن، استلام. التحويل لا يُنشئ مخزوناً أبداً.",
  Staff: "الموظفون",
  "Staff branches": "فروع الموظفين",
  "Staff work in their home branch plus any branches added here. Owners can work in every branch.":
    "يعمل الموظفون في فرعهم الأساسي وأي فروع تُضاف هنا. يمكن للمالكين العمل في كل الفروع.",
  Standalone: "مستقل",
  ...
  "Stock locations and transfers": "مواقع المخزون والتحويلات",
  "Stock movements": "حركات المخزون",
  ...
  "The default stockroom holds whatever is not recorded at another location. Selling always uses the branch total.":
    "المستودع الافتراضي يحتوي كل ما لم يُسجَّل في موقع آخر. البيع يعتمد دائماً على إجمالي الفرع.",
  ...
  "The home branch always stays. Signed-in sessions pick up changes at the next sign-in.":
    "يبقى الفرع الأساسي دائماً. تُطبَّق التغييرات على الجلسات عند تسجيل الدخول التالي.",
  ...
  "Valid for (hours)": "صالح لمدة (ساعات)",
  Validate: "تحقّق",
  ...
  "Value of each point": "قيمة كل نقطة",
  "Value of one point when redeemed": "قيمة النقطة الواحدة عند الاستبدال",
  ...
  "e.g. Owner's phone": "مثال: هاتف المالك",
  "earns about {0}": "يكسب حوالي {0}",
  "excl.": "غير شامل",
  "incl.": "شامل",
