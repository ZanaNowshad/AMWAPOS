...
pub const TABLES: &[(&str, &[&str], Policy)] = &[
    ...
    ("loyalty_ledger", &["entry_id"], Policy::Append),
    ("stock_transfers", &["transfer_id"], Policy::Shared),
    ("stock_transfer_lines", &["transfer_id", "line_no"], Policy::Shared),
    ("digital_orders", &["order_id"], Policy::Shared),
    ("digital_order_lines", &["order_id", "line_no"], Policy::Shared),
